...
public class InOut {
     ...
     * lido naquele momento por aquela caixa de texto. Le entao uma String e a
     * converte para um objeto do tipo byte. Se na conversao ocorrer algum erro,
     * o processo sera feito novamente, ou seja, sera lida outra String e
     * convertida para byte. O processo soh para quando a conversao for bem
     * sucedida.
     *
     * @param frase que sera usada para o usuario saber qual dado sera lido
    ...
    /**
     * Este metodo eh para entrada de um objeto do tipo short. Tem como
     * parametro de entrada uma String que indicara para o usuario qual o dado
     * que sera lido naquele momento por aquela caixa de texto. Le entao uma
     * String e a converte para um objeto do tipo short. O processo so para
     ...
     * de entrada uma String que indicara para o usuario qual o dado que sera
     * lido naquele momento por aquela caixa de texto. Le entao uma String e a
     * converte para um objeto do tipo int. O processo so para quando a
     * conversao for bem sucedida.
     *
     * @param frase que sera usada para o usuario saber qual dado sera lido
     ...
     * de entrada uma String que indicara para o usuario qual o dado que sera
     * lido naquele momento por aquela caixa de texto. Le entao uma String e a
     * converte para um objeto do tipo long. O processo so para quando a
     * conversao for bem sucedida.
     *
     * @param frase que sera usada para o usuario saber qual dado sera lido
    ...
    /**
     * Este metodo eh para entrada de um objeto do tipo float. Tem como
     * parametro de entrada uma String que indicara para o usuario qual o dado
     * que sera lido naquele momento por aquela caixa de texto. Le entao uma
     * String e a converte para um objeto do tipo float. O processo so para
     * quando a conversao for bem sucedida.
     *
     * @param frase que sera usada para o usuario saber qual dado sera lido
     ...
     * de entrada uma String que indicara para o usuario qual o dado que sera
     * lido naquele momento por aquela caixa de texto. Le entao uma String e
     * retorna apenas o primeiro caracter da String.
     *
     * @param frase que sera usada para o usuario saber qual dado sera lido
    ...
    /**
     * Este metodo foi criado para mandar uma mensagem com o icone de ERRO
     *
    ...
    /**
     * Este metodo foi criado para mandar uma mensagem com o icone de INFORMACAO
     *
    ...
    /**
     * Este metodo foi criado para mandar uma mensagem com o icone de AVISO
     *
     * @param cabecalho que aparecera no topo da mensagem
     * @param frase que aparecera dentro da caixa de mensagem
     */
